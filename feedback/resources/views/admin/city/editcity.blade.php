        ...
        <div class="row ">
            <div class="col-md-12">
                <div class="card m-b-20">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('admin.updatecity', $city->id) }}">
                            @csrf
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <div class="form-group">
                                        <label class="form-label" for="exampleInputEmail1">ქალაქის სახელი</label>
                                        <input type="text" class="form-control" id="cityname" name="cityname" placeholder="შეიყვანეთ ქალაქის სახელი" value="{{ $city->name }}">
                                    </div>
                                </div>
                            </div>
