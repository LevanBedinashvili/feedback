        ...
        <div class="row">
            ...
            <div class="col-xl-9 col-lg-12 col-md-12">
                ...
                <div class="card mb-0">
                    ...
                    <form action="{{ route('subject.photosstore' , $id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            <div class="row">
                                <div class="card">
                            ...
                            <table class="table table-bordered table-hover mb-0 text-nowrap">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('subject.photoDelete', $image->id) }}"class="btn btn-danger btn-sm text-white" data-toggle="tooltip" data-original-title="Delete"><i class="fa fa-trash-o"></i></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
