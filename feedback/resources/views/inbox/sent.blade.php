								...
								<div class="col-md-12 col-lg-3">
									<div class="card-body p-0 border">
										<div class="list-group list-group-transparent mb-0 mail-inbox">
											...
											<a href="{{ route('recived') }}" class="list-group-item list-group-item-action d-flex align-items-center">
														...
														<tbody>
                                                            ...
                                                            <tr>
                                                                <td class="inbox-small-cells">
                                                                    <input type="checkbox" class="mail-checkbox delete_checkbox" name="checkbox" value="{{ $msg->id }}">
                                                                </td>
                                                                <td class="view-message  dont-show" ><a href="{{ route('openmessage', $msg->id) }}"> {{ $msg->reciver->fname }} {{ $msg->reciver->lname }}</a></td>
                                                                <td class="view-message"><a href="{{ route('openmessage', $msg->id) }}"> {{ $msg->text }}</a></td>
                                                                <td class="view-message  text-right" ><a href="{{ route('openmessage', $msg->id) }}"> {{ \Carbon\Carbon::parse($msg->date_2)->diffForHumans(\Carbon\Carbon::parse($current_date)); }}</a></td>
                                                            </tr>
                                                            @endforeach
